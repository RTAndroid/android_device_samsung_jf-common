...
# Kernel
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 acpi_irq_nobalance noirqbalance isolcpus=1 androidboot.hardware=qcom user_debug=31 zcache msm_rtb.filter=0x3F ehci-hcd.park=3
